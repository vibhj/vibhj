...
if (isset($_SESSION['email'])) {
  ...
  <html lang='en'>
    ...
    $query_1 = "Select * from teacher where Email='$e'";
  ...
  <div class='row'>
    <nav id='sidebarMenu' class='col-md-3 col-lg-2 d-md-block bg-dark sidebar'>
      <div class='position-fixed pt-3'>
        <ul class='nav flex-column'>
          ...
          <li class='nav-item'>
            <a class='nav-link active' href='teacher_dashboard_profile.php'>
    ...
    <main class='col-md-9 ms-sm-auto col-lg-10 px-md-4'>
      <div class='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom'>
        <div class='container'>
          <h1 class='h2'><img alt='...' src='assets/img/upload_photo/$ans1[17]' style='border-radius: 50%; width: 100px; height: 100px;'> &nbsp; $ans1[0]  $ans1[1]</h1>
        </div>
        </div>";
        ...
        <div class='container-fluid pt-4 px-4'>
          ...
          <form method='POST' action='teacher_profile.php' enctype='multipart/form-data'>
           ...
           <a class='fs-3 fw-bold'  data-bs-toggle='collapse' href='#collapseExample2'  aria-expanded='false' aria-controls='collapseExample2' style='text-decoration: none; color:  #1C6EA4;'>
            <span><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='-2.1 -5 16 16' preserveAspectRatio='xMinYMid meet' overflow='visible'><path d='M.5 0C0 0-.2.3.2.7l5 5c.4.4 1 .4 1.4 0l5-5c.4-.4.3-.7-.3-.7H.5z' fill='#999'/></svg></span>   Educational Details 
            </a>
           <div class='collapse container overflow-hidden' id='collapseExample2' style='padding-top: 2%;'>
                <div class='row g-2'>

                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Class 10<sup>th</sup> Percentage</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[9]' disabled>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Class 12<sup>th</sup> Percentage</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[10]' disabled>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Highest Qualification Degree</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[11]' disabled>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Highest Qualification Percentage</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[12]' disabled>
                    </div>
                  </div>
                  <div class='col-4'></div>
           ...
           <a class='fs-3 fw-bold'  data-bs-toggle='collapse' href='#collapseExample3'  aria-expanded='false' aria-controls='collapseExample2' style='text-decoration: none; color:  #1C6EA4;'>
            <span><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='-2.1 -5 16 16' preserveAspectRatio='xMinYMid meet' overflow='visible'><path d='M.5 0C0 0-.2.3.2.7l5 5c.4.4 1 .4 1.4 0l5-5c.4-.4.3-.7-.3-.7H.5z' fill='#999'/></svg></span>   Teaching Related 
            </a>
           <div class='collapse container overflow-hidden' id='collapseExample3' style='padding-top: 2%;'>
                <div class='row g-2'>

                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Subjects</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[13]' name='subject'>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Experience in year(s)</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[14]' name='teach_experience'>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Trial Days</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[15]' name='trial_days'>
                    </div>
                  </div>
                  <div class='col-4'></div>
           ...
           <a class='fs-3 fw-bold'  data-bs-toggle='collapse' href='#collapseExample4'  aria-expanded='false' aria-controls='collapseExample2' style='text-decoration: none; color:  #1C6EA4;'>
            <span><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' viewBox='-2.1 -5 16 16' preserveAspectRatio='xMinYMid meet' overflow='visible'><path d='M.5 0C0 0-.2.3.2.7l5 5c.4.4 1 .4 1.4 0l5-5c.4-.4.3-.7-.3-.7H.5z' fill='#999'/></svg></span>   Documents Related 
            </a>
           <div class='collapse container overflow-hidden' id='collapseExample4' style='padding-top: 2%;'>
                <div class='row g-2'>

                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Drive Link</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
                      <input class='form-control' type='text' value='$ans1[16]' name='link'>
                    </div>
                  </div>
                  <div class='col-4'></div>
                  <div class='col-4'>
                  ...
                  <div class='col-4'></div>
                  <div class='col-4'>
                    <div class='p-3 fs-5 fw-bold'>Upload New Resume</div>
                  </div>
                  <div class='col-3'>
                    <div class='p-3'>
