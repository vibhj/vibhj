  ...
  <div class='row'>
    <nav id='sidebarMenu' class='col-md-3 col-lg-2 d-md-block bg-dark sidebar'>
      <div class='position-fixed pt-3'>
        <ul class='nav flex-column'>
          ...
          <li class='nav-item'>
            <a class='nav-link active' href='student_dashboard_profile.php'>
    ...
    <main class='col-md-9 ms-sm-auto col-lg-10 px-md-4'>
      <div class='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom'>
        <div class='container'>
          <h1 class='h2'><img alt='...' src='assets/img/upload_photo/$ans1[10]' style='border-radius: 50%; width: 100px; height: 100px;'> &nbsp; $ans1[0]  $ans1[1]</h1>
        </div>
        </div>";
