...
if (isset($_SESSION['email'])) {
  ...
  $query_1 = "Select * from studentparent";
  ...
  <div class='row'>
    <nav id='sidebarMenu' class='col-md-3 col-lg-2 d-md-block bg-dark sidebar'>
      <div class='position-fixed pt-3'>
        <ul class='nav flex-column'>
          ...
          <li class='nav-item'>
            <a class='nav-link active' href='admin_dashboard_studentparent.php'>
             <i class='bi bi-table'></i>
              Students/Parents
            </a>
          </li>
    ...
    <main class='col-md-9 ms-sm-auto col-lg-10 px-md-4'>
      <div class='d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom'>
        <h1 class='h2'>Registered Students/Parents</h1>
        </div>";
      ...
      echo "<th scope='col' > Current Class </th>";
      ...
      echo "<td >";
      echo "<img src='assets/img/upload_photo/"; echo $row_1[10];
